...
<html>
    ...
    <g:isAdmin errorMsg="Non autorisé">
		<a href="#edit-vote" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-vote" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:voteInstance, action:'update']" method="PUT" >
